...
/// <summary>
/// A mutable grid which dynamically expands.
/// Specifically, calling <see cref="Set"/> will increase
/// the <see cref="Bounds"/> whenever it is necessary.
/// </summary>
public sealed class ExpandableGrid<T> : IGrid<T>
{
    ...
    /// <summary>
    /// A good <paramref name="boundsHint"/> reduces the amount of wasted space,
    /// but has no other observable effects.
    /// </summary>
    public ExpandableGrid(T defaultValue, Rect boundsHint)
    {
